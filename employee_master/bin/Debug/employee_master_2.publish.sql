...
GO
PRINT N'Creating Procedure [dbo].[spEmployee_GetAllOrSearch]...';


GO
CREATE PROCEDURE [dbo].[spEmployee_GetAllOrSearch]
	@SearchText NVARCHAR(50)
AS
BEGIN
	SELECT [e].[Id], [e].[FirstName], [e].[LastName], [e].[PhoneNumber], [e].[HireDate], [e].[Salary], [e].[JobId], [e].[Status], [j].[Title] 
