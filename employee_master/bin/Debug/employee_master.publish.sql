...
GO
PRINT N'Creating Foreign Key [dbo].[FK_Employees_Jobs]...';


GO
ALTER TABLE [dbo].[Employees]
    ADD CONSTRAINT [FK_Employees_Jobs] FOREIGN KEY ([JobId]) REFERENCES [dbo].[Jobs] ([Id]);


GO
PRINT N'Creating Procedure [dbo].[spEmployee_ViewAll]...';


GO
CREATE PROCEDURE [dbo].[spEmployee_ViewAll]
AS
BEGIN
	SELECT [e].[FirstName], [e].[LastName], [e].[PhoneNumber], [e].[HireDate], [e].[Salary], [e].[JobId], [e].[Status], [j].[Title] 
	FROM dbo.Employees e
	INNER JOIN dbo.Jobs j
		ON j.Id = e.JobId
END
GO
PRINT N'Creating Procedure [dbo].[spEmployees_DeleteById]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[spEmployees_Insert]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[spEmployees_Update]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'e73e0d15-6ffe-4557-8644-fbd8f32bedf4')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('e73e0d15-6ffe-4557-8644-fbd8f32bedf4')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1a608356-0e43-46b5-afd6-a809ad15e0f1')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1a608356-0e43-46b5-afd6-a809ad15e0f1')
